...
export async function registerUserController(req, res) {
  try {
    ...
    try {
      ...
      return res.status(201).json({
        message:
          "User registered successfully. However, verification email could not be sent. Please contact support.",
        error: false,
        success: true,
        data: save,
...
export async function verifyEmailController(req, res) {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Internal server error in verifying email controller",
        error: true,
        success: false,
      });
  }
...
export async function loginController(req, res) {
  try {
    ...
    if (!user) {
      return res
        .status(404)
        .json({ message: "User not registered", error: true, success: false });
    }
...
export async function uploadAvatar(req, res) {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Internal server error in upload avatar controller",
        error: true,
        success: false,
      });
  }
...
export async function updateUserDetails(req, res) {
  try {
    ...
    res
      ...
      .json({
        message:
          error.message || "Internal server error in updating user details",
        error: true,
        success: false,
      });
  }
  ...
  try {
    ...
    res
      ...
      .json({
        message:
          error.message ||
          "Internal server error in forgot password controller",
        error: true,
        success: false,
      });
  }
  ...
  try {
    ...
    res
      ...
      .json({
        message:
          error.message ||
          "Internal server error in verifying forgot password OTP",
        error: true,
        success: false,
      });
  }
...
export async function resetPassword(req, res) {
  try {
    ...
    if (!email || !newPassword || !confirmPassword) {
      return res
        .status(400)
        .json({ message: "Enter Email and New Password or Confirm Password" });
    }
    ...
    res
      .status(500)
      .json({
        message: error.message || "Internal server error in resetting password",
        error: true,
        success: false,
      });
  }
...
export async function refreshToken(req, res) {
  try {
    ...
    return res.status(500).json({
      message:
        error.message || "Internal server error in refreshing access token",
      error: true,
      success: false,
    });
  }
...
export async function userDetails(req, res) {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Internal server error in fetching user details",
        error: true,
        success: false,
      });
  }
