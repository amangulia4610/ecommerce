            ...
            <div className="p-8 space-y-12">
              ...
              <div>
                ...
                <div className="prose max-w-none text-gray-600 leading-relaxed space-y-4">
                  <p>
                    Welcome to 10 Fit ("we," "our," or "us"). This Privacy
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    ...
                    <ul className="space-y-2 text-blue-800">
                      ...
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                        <span>
                          Payment information (securely processed by third
                          parties)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                        <span>
                          Health information you choose to share for
                          consultations
                        </span>
                      </li>
                    </ul>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    ...
                    business, or serving you. These parties are bound by
                    confidentiality agreements and are prohibited from using
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-2xl p-6">
              ...
              <p className="text-blue-700 mb-4">privacy@10fit.com</p>
