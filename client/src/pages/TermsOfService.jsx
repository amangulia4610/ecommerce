      ...
      <section className="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Please read these terms carefully before using our services. These terms govern your use of 20 Degrees.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Key points about our terms and your rights</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">User Responsibilities</h3>
              <p className="text-gray-600 text-sm">Use our services responsibly and legally</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Quality products and reliable service</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Respect for copyrights and trademarks</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Important limitations and disclaimers</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="p-8 space-y-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    By accessing and using the 20 Degrees website and services, you accept and agree to be bound 
                    by the terms and provision of this agreement. If you do not agree to abide by the above, 
                    please do not use this service.
                  </p>
                  <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                    <h3 className="font-bold text-green-900 mb-3">By using our services, you agree to:</h3>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-blue-900 mb-4">Permitted Uses</h3>
                    <ul className="space-y-2 text-blue-800">
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                        <span>Browse and purchase products for personal use</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                  ...
                  <div className="bg-red-50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-red-900 mb-4">Prohibited Uses</h3>
                    <ul className="space-y-2 text-red-800">
                      ...
                      <li className="flex items-start gap-2">
                        <FaBan className="text-red-600 mt-1 flex-shrink-0" />
                        <span>Resell products commercially without authorization</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-gray-600">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-purple-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-purple-900 mb-3">Your Responsibilities</h3>
                    ...
                    <div className="bg-indigo-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-indigo-900 mb-3">Our Rights</h3>
              ...
              {/* Products and Orders */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Products and Orders</h2>
                <div className="space-y-4 text-gray-600">
                  <p>
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
                  <div className="space-y-4 text-orange-800">
                    <p className="font-semibold">
                      IMPORTANT: The health information and products offered on this site are not intended 
                      to diagnose, treat, cure, or prevent any disease.
                    </p>
                    <ul className="space-y-2">
                      <li>• Always consult with healthcare professionals before starting new supplements</li>
                      ...
                      <li>• Stop use and consult a doctor if you experience any side effects</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    ...
                    the exclusive property of 20 Degrees and its licensors. The service is protected by 
                    copyright, trademark, and other laws.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-purple-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-purple-900 mb-3">Protected Content</h3>
                      <ul className="space-y-2 text-purple-800 text-sm">
                        <li>• Website design and layout</li>
                        <li>• Product descriptions and images</li>
                        <li>• 20 Degrees logo and branding</li>
                        <li>• Educational content and articles</li>
                      </ul>
                    </div>
                    
                    <div className="bg-pink-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-pink-900 mb-3">Your Rights</h3>
              ...
              <div>
                ...
                <div className="bg-gray-100 rounded-xl p-6">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    In no event shall 20 Degrees, nor its directors, employees, partners, agents, suppliers, 
                    or affiliates, be liable for any indirect, incidental, special, consequential, or punitive 
                    damages, including without limitation, loss of profits, data, use, goodwill, or other 
                    intangible losses, resulting from your use of the service.
                  </p>
                  <p className="text-gray-700 text-sm">
                    Our total liability to you for all claims shall not exceed the amount you paid for 
                    products or services in the 12 months preceding the claim.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    These Terms shall be interpreted and governed by the laws of the Province of Ontario, Canada, 
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 rounded-2xl p-6">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-2">Email Legal Team</h3>
              <p className="text-blue-700 mb-4">legal@20degrees.com</p>
            ...
            <div className="bg-green-50 rounded-2xl p-6">
              ...
              <h3 className="text-xl font-bold text-green-900 mb-2">Call Legal Hotline</h3>
