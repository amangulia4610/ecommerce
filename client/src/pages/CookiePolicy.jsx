      ...
      <section className="bg-gradient-to-r from-orange-900 via-red-900 to-pink-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-orange-100 max-w-3xl mx-auto leading-relaxed">
            Learn about how we use cookies to enhance your browsing experience and protect your privacy.
          </p>
          <p className="text-sm text-orange-200 mt-4">Last updated: January 2025</p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-200 mb-16">
            ...
            <p className="text-gray-600 mb-8">
              Customize your cookie settings below. Essential cookies are required for the website to function 
              ...
              {[
                {
                  ...
                  description: 'Required for basic website functionality, security, and your account access.',
                  icon: FaShieldAlt,
                  color: 'green',
                  required: true
                },
                  ...
                  <div key={index} className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div className="flex items-start gap-4 flex-1">
                        <div className={`w-12 h-12 bg-${cookie.color}-100 rounded-xl flex items-center justify-center flex-shrink-0`}>
                          <IconComponent className={`w-6 h-6 text-${cookie.color}-600`} />
                        </div>
            ...
            <div className="p-8 space-y-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-blue-900 mb-3">How Cookies Work</h3>
                    <ul className="space-y-2 text-blue-800">
                      ...
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                        <span>Contain information about your preferences and actions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <FaCheckCircle className="text-blue-600 mt-1 flex-shrink-0" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-green-900">Essential Cookies</h3>
                    </div>
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-blue-900">Analytics Cookies</h3>
                    </div>
                  ...
                  <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-purple-900">Marketing Cookies</h3>
                    </div>
                  ...
                  <div className="bg-orange-50 rounded-xl p-6 border border-orange-200">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-lg font-bold text-orange-900">Preference Cookies</h3>
                    </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p>
                    ...
                    These services may set their own cookies to provide features like social media 
                    integration, analytics, and advertising.
                  </p>
                  <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
                    <h3 className="text-lg font-bold text-yellow-900 mb-3">Third-Party Services We Use</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-semibold text-yellow-800 mb-2">Analytics</h4>
                      ...
                      <div>
                        <h4 className="font-semibold text-yellow-800 mb-2">Marketing</h4>
                        <ul className="text-yellow-700 text-sm space-y-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-yellow-800 mb-2">Social Media</h4>
                        <ul className="text-yellow-700 text-sm space-y-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-yellow-800 mb-2">Customer Support</h4>
                        <ul className="text-yellow-700 text-sm space-y-1">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-blue-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-blue-900 mb-3">On Our Website</h3>
                    ...
                    <div className="bg-purple-50 rounded-xl p-6">
                      <h3 className="text-lg font-bold text-purple-900 mb-3">In Your Browser</h3>
                  ...
                  <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-red-900 mb-2">Important Note</h3>
                        <p className="text-red-800 text-sm">
                          Disabling certain cookies may limit website functionality. Essential cookies 
                          are required for basic features like shopping cart and account access.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {/* Cookie Lifespan */}
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Cookie Lifespan</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-indigo-50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-indigo-900 mb-3">Session Cookies</h3>
                  ...
                  <div className="bg-teal-50 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-teal-900 mb-3">Persistent Cookies</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Contact us if you have any questions about our use of cookies or this policy.
          </p>
          
          <div className="bg-orange-50 rounded-2xl p-8">
            <FaCookie className="text-4xl text-orange-600 mb-4 mx-auto" />
            <h3 className="text-xl font-bold text-orange-900 mb-4">Cookie Support</h3>
