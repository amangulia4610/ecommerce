  ...
  const heroSlides = [
    {
      ...
      description:
        "Discover cutting-edge health technology, premium supplements, and fitness solutions for the modern wellness enthusiast",
    ...
    },
    {
      ...
      description:
        "Premium protein powders and multivitamins formulated by nutritionists for optimal health and performance",
    ...
    },
    {
      ...
      description:
        "Professional-grade health monitors and fitness trackers for real-time insights into your wellness journey",
      ...
      <section className="relative h-[80vh] overflow-hidden bg-black">
        ...
        >
          {heroSlides.map((slide, index) => (
            <div
              key={index}
              className={`min-w-full h-full bg-gradient-to-r ${slide.bgColor} flex items-center relative overflow-hidden`}
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 group"
                >
                  <div
                    className={`w-12 h-12 bg-${stat.color}-100 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
                    <IconComponent
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore our curated collection of premium health and wellness
              products
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 ${config.bgPattern} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  ></div>

                  <div className="relative p-8">
                    <div className="flex items-start justify-between mb-6">
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${config.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
              ...
              <div key={product._id} className="group relative">
                <div className="absolute -top-2 -left-2 z-10">
                  <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1">
                    <FaTrophy className="text-xs" />#{index + 1}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Experience premium service with every order
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Free shipping on orders over $100 CAD with same-day delivery in major cities",
                color: "blue",
              },
              {
                icon: FaShieldAlt,
                title: "Secure & Safe",
                description:
                  "Bank-level security with 256-bit SSL encryption and fraud protection",
                color: "green",
              },
              {
                icon: FaHeadset,
                ...
                description:
                  "Health professionals available round the clock for guidance",
                color: "purple",
              },
              {
                icon: FaGift,
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Get <span className="font-bold text-yellow-300">15% off</span> your
            first order plus exclusive health tips, product launches, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                At 10 Fit, we believe optimal health is the foundation of a
                fulfilling life. We curate premium health technology,
                supplements, and wellness solutions to help you achieve your
                goals.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Carefully curated from trusted brands",
                  },
                  {
                    icon: FaFlask,
                    title: "Science-Backed",
                    desc: "Evidence-based health solutions",
                  },
                  {
                    icon: FaUsers,
                    title: "Expert Support",
                    desc: "Health professionals at your service",
                  },
                  {
                    icon: FaAward,
                    title: "Proven Results",
                    desc: "Thousands of success stories",
                  },
                ].map((item, index) => {
            ...
            <div className="relative">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-2xl border border-gray-100">
                  <img
                    src="/10-fit-weight-management-app.png"
                    alt="10 Fit Health & Wellness"
